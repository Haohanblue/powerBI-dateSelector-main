...
> {
  ...
  public onDateChanged = (e: Date[]) => {
    ...
    if (
      e.length &&
      (format(e[0], "HH-mm-ss dd-MM-yyyy") !==
        format(this.state.dates.start, "HH-mm-ss dd-MM-yyyy") ||
        format(e[1], "HH-mm-ss dd-MM-yyyy") !==
          format(this.state.dates.end, "HH-mm-ss dd-MM-yyyy"))
    ) {
      this.setState({
        dates: {
          start: e[0],
